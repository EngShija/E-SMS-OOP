...
<div class="d-flex justify-content-center">
    <div class="card text-center mb-3 mt-3" style="width: 20rem;">
        <div class="card-body">       
            <h5 class="mb-0">Delete <strong><?= strtoupper($myStudent['first_name']). " ". strtoupper($myStudent['last_name']) ?></strong></h5>
            <p class="mb-0">Are You Sure, This action can not be undone!</p>
